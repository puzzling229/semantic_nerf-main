...
def train():
    ...
    parser.add_argument('--config_file', type=str, default="/home/shuaifeng/Documents/PhD_Research/CodeRelease/SemanticSceneRepresentations/SSR/configs/SSR_room0_config_test.yaml", 
                    help='config file name.')
    parser.add_argument('--dataset_type', type=str, default="replica_instance", choices= ["replica", "replica_nyu_cnn", "scannet","replica_instance"],
    ...
    if args.dataset_type == "replica":
        ...
        train_sem_ids = list(range(0, total_num, step))
    ...
    timespend = time.time()-time01
    print('The total time for Training is :' , timespend)
    print('done')
